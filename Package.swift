...
let package = Package(
    ...
    products: [
        ...
        .library(name: "TreeSitterNimQueries", targets: ["TreeSitterNimQueries"]),
        .library(name: "TreeSitterNimRunestone", targets: ["TreeSitterNimRunestone"]),
    ...
    targets: [
        ...
        .target(name: "TreeSitterNim", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterNimQueries", resources: [.copy("highlights.scm")]),
        .target(name: "TreeSitterNimRunestone", dependencies: ["Runestone", "TreeSitterNim", "TreeSitterNimQueries"]),
